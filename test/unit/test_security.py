...
from app_classifier.security import verify_password, get_current_user, encode_user


sec_data = [({"username": "client_user", "hashed_password": bcrypt.hash("tryClassifier",
            ...
            pytest.param({"username": "client_user",
                         ...
                         "0.PqONjMIGhLn9LGTWVltA0K1GhihH5WdHvvvKbP0VIBU", marks=pytest.mark.xfail)]
...
def test_verify_password(password, hashed_password) -> None:
